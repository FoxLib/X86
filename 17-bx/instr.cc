...
void machine::step() {
    ...
    switch (opcode = get_opcode()) {
        ...
        case 0xFE: { // INC/DEC b8

            fetch_modrm();
            switch (modrm_reg) {

                case 0: t32 = get_cf(); put_eb(do_add(get_eb(), 1, 0)); set_cf(t32); break;
                case 1: t32 = get_cf(); put_eb(do_sub(get_eb(), 1, 0)); set_cf(t32); break;
                default: ud();
            }
        ...
        case 0xFF: { // Grp
            ...
            switch (modrm_reg) {
                ...
                case 0: t32 = get_cf(); put_ev(do_add(get_ev(), 1, 1)); set_cf(t32); break;
                case 1: t32 = get_cf(); put_ev(do_sub(get_ev(), 1, 1)); set_cf(t32); break;           
                ...
                case 3:
                    ...
                    t32 = phys_addr(segment, get_ev());
                    a32 = opsize ? read_dword(t32)   : read_word(t32);
                    t32 = opsize ? read_dword(t32+4) : read_word(t32+2);                    
                    do_call_far(a32, t32);
                    break;
